...
public class VisualBasic6Parser extends Parser {
	...
	public static final int
		...
		RULE_subscripts = 127, RULE_subscript_ = 128, RULE_ambiguousIdentifier = 129, 
		...
		RULE_letterrange = 136, RULE_lineLabel = 137, RULE_literal = 138, RULE_type_ = 139, 
	...
	public final Subscript_Context subscript_() throws RecognitionException {
		...
		enterRule(_localctx, 256, RULE_subscript_);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2502);
	...
	public final Type_Context type_() throws RecognitionException {
		...
		enterRule(_localctx, 278, RULE_type_);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
